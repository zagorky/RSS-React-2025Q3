...
export const getEmptyQueryResponse = () => {
  return {
    pagination: {
...
export const getSpecificQueryResponse = () => {
  return {
    pagination: {
      last_visible_page: 1,
      has_next_page: false,
    ...
    data: [
      ...
      },
      {
        ...
        images: {
          jpg: {
            image_url:
              'https://cdn.myanimelist.net/images/anime/1089/148301.jpg',
            small_image_url:
      ...
      },
      {
        ...
        images: {
          jpg: {
            image_url:
              'https://cdn.myanimelist.net/images/anime/1045/150038.jpg',
            small_image_url:
